...
if has("gui_running")
    ...
    if v:version >= 700
        ...
        exec "hi MatchParen     cterm=UNDERLINE ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(80)

        exec "hi TabLine cterm=underline ctermbg=black ctermfg=lightgrey"
        exec "hi TabLineFill cterm=underline"
        exec "hi TabLineSel ctermfg=lightblue"
    endif
endif
