...
--
myLayout = avoidStruts (tiled ||| Mirror tiled ||| magnify Grid ||| noBorders mytabs)
  where
     ...
     -- Brought in from Andrea Rossato's config
...
myManageHook = composeAll
    ...
    , className =? "org-gjt-sp-jedit-jEdit" --> doFloat
    , className =? "freemind-main-FreeMindStarter" --> doFloat
    , className =? "org-argouml-application-Main" --> doFloat
    ...
    , className =? "DeploymentLab-HPMain" --> doFloat
