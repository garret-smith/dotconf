...
KC_LGUI, KC_LCTL, LALT_T(KC_MINS), KC_BSPC, LT(2,KC_DEL),       LT(1,KC_ENT), KC_SPC, KC_RALT, KC_RCTL, KC_RGUI
),
	[1] = LAYOUT(
...
KC_NO, RGB_TOG, RGB_MOD, RGB_VAI, RGB_SPI, KC_NO,             KC_NO, DT_PRNT, DT_UP, DT_DOWN, KC_NO, KC_NO,
KC_NO, KC_NO, RGB_RMOD, RGB_VAD, RGB_SPD, BL_UP,              KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO,
KC_NO, KC_NO, BL_TOGG, BL_STEP, BL_BRTG, BL_DOWN, KC_NO,      KC_NO, KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_NO,
KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
)
};
